...
# Methods
RNA-Seq, 75bp single end, libraries were generated from matched patient samples from endometrial scratch (n=7) and menstrual flow treatment (n=7). The raw sequencing data are deposited at EBI-EMBL ArrayExpress with experimental code <b>E-MTAB-9284</b>. <br>
